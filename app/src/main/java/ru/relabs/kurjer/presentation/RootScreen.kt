...
sealed class RootScreen(protected val fabric: () -> Fragment) : SupportAppScreen() {
    ...
    class TaskInfo(task: Task) : RootScreen({ TasksFragment.newInstance(false) }) //TODO
    class Addresses(tasks: List<Task>) : RootScreen({ TasksFragment.newInstance(false) }) //TODO
}
